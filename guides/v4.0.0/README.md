...
```sh
composer create-project barak-framework/barak=v4.0.0 project_name
```
...
Barak is released under the [MIT License](http://www.opensource.org/licenses/MIT).**# BARAK FRAMEWORK
